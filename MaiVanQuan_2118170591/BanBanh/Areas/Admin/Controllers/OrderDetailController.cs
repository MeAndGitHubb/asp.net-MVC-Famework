...
namespace BanBanh.Areas.Admin.Controllers
{
    public class OrderDetailController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,OrderId,ProductId,Number,Price,Amount,Sale,Note,Status")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,OrderId,ProductId,Number,Price,Amount,Sale,Note,Status")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
