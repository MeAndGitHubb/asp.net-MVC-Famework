...
namespace BanBanh.Areas.Admin.Controllers
{
    public class SaleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,OrderId,ProductId,Fix,Price,Amount,Status")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,OrderId,ProductId,Fix,Price,Amount,Status")] Sale sale)
        {
            if (ModelState.IsValid)
            {
